          ...
          <div className="grid lg:grid-cols-[0.8fr_1.2fr]">
            ...
            <div className="p-8 sm:p-10 lg:p-12">
              ...
              <p className="mt-4 text-lg font-semibold leading-8 text-slate-700">
                {directorGeneral.title}
              </p>

              <p className="mt-1 leading-7 text-slate-500">
                {directorGeneral.institution}
              </p>
              ...
              <div className="mt-8 flex items-start gap-3 border-t border-slate-200 pt-8">
                ...
                <p className="leading-8 text-slate-600">
                  The Director General provides administrative and
                  technical leadership and coordinates the Ministry's
                  departments, institutional operations and
                  implementation of government planning priorities.
                </p>
              </div>
